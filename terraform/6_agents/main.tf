    ...
    Statement = [
      ...
      # Bedrock access for all agents
      {
        ...
        Resource = [
          ...
          "arn:aws:bedrock:eu-west-2:*:inference-profile/*",
          "arn:aws:bedrock:eu-west-3::foundation-model/*",
          "arn:aws:bedrock:eu-west-3:*:inference-profile/*",
...
resource "aws_lambda_function" "planner" {
  ...
  environment {
    variables = {
      ...
      AWS_REGION_NAME    = var.bedrock_region  # Required by LiteLLM for Bedrock

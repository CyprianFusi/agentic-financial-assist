            ...
            if 'analysis' in payload:
                ...
                if isinstance(analysis, str):
                    ...
                    if contains_reasoning:
                        print("[WARN] WARNING: Analysis may contain reasoning/thinking text")
                    else:

...
This module defines a Lambda handler that runs a Retirement Specialist agent
to generate retirement planning advice based on user preferences and portfolio data.
The agent interacts with a database to fetch user data and save the analysis results.
It includes retry logic for handling temporary errors such as rate limits and timeouts.
"""

import os

# IMPORTANT: Set AWS_REGION_NAME before importing LiteLLM to ensure correct Bedrock region
# LiteLLM reads this at import time for boto3 client initialization
os.environ["AWS_REGION_NAME"] = os.environ.get("BEDROCK_REGION", os.environ.get("AWS_REGION_NAME", "eu-west-1"))

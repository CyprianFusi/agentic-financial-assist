...
This module defines a Lambda handler that runs a Report Writer agent to analyze
a portfolio and generate a report.
The handler expects a job ID, portfolio data, and user data as input,
and returns a report as output.
It includes error handling, rate limiting retries, and observability features.
"""

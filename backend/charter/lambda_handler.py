...
This module defines a Lambda handler for orchestrating financial portfolio analysis
using a custom agent.
The orchestrator handles job initiation, manages missing instruments, and executes the agent.
It also handles the response and updates the database accordingly.
It includes robust error handling and logging for observability.
"""

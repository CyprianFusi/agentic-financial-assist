...
Generates structured output including asset class, regional, and sector allocations.
Uses LiteLLM Bedrock model for classification with retry logic for rate limits.
Designed for integration with a FastAPI backend and database storage.
"""
